...
class Ui_WizardPage2(object):
    def setupUi(self, WizardPage2):
        ...
        self.pushButtonAddCapa.setGeometry(QtCore.QRect(330, 200, 121, 23))
        ...
        self.comboBoxTipoCapa.addItem(_fromUtf8(""))
        self.comboBoxTipoCapa.addItem(_fromUtf8(""))
        self.pushButtonNext = QtGui.QPushButton(WizardPage2)
        self.pushButtonNext.setGeometry(QtCore.QRect(340, 250, 101, 23))
    ...
    def retranslateUi(self, WizardPage2):
        ...
        self.pushButtonNext.setText(_translate("WizardPage2", "Next", None))
